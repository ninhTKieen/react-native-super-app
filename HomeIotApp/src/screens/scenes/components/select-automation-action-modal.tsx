...
type TSelectAutomationActionModalProps = {
  isVisible: boolean;
...
const SelectAutomationActionModal = (
  props: TSelectAutomationActionModalProps,
) => {
...
export default SelectAutomationActionModal;
