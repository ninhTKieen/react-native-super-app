...
type TZigbeeCurtainSwitchesProps = {
  device: IDevice;
...
const ZigbeeCurtainSwitchesFunc = (props: TZigbeeCurtainSwitchesProps) => {
  const {
    device,
    deviceDetailQuery,
    deviceActions,
    ...
    <View className="bg-transparent">
      ...
      >
        <Text className="p-3 text-center text-base font-medium text-[#515151]">
          {t(i18nKeys.device.curtainSw)} {selectedSwitchIndex + 1}
        </Text>
      ...
      <View>
        <SelectMomentOption
          ...
          options={
            isRemoveToggle
              ? deviceScenes?.curtains?.[selectedSwitchIndex]?.options
          ...
          onOptionPress={(option) => {
            const action = {
              ...
              attribute: deviceScenes?.curtains?.[selectedSwitchIndex]
                ?.key as string,
      ...
      <SelectDeviceModal
        ...
        deviceName={t(i18nKeys.device.curtainSw)}
        devices={deviceScenes?.curtains}
...
export default ZigbeeCurtainSwitchesFunc;
